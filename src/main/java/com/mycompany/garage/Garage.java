...
public class Garage {
    ...
    public Garage() {
        ...
        do {
            ...
            j++;
        } while (scelta != 'n');//fine do-while
        
    }

    private void Inserisci(int p) {
        ...
        do {
            ...
            try {
                ...
                Auto A = new Auto(p, 4, alimentazione, "fiat", 2000, 1200);
        ...
        Moto M = new Moto(p, 4, "aprilia", 2000, 600);
        elencoVeicoli[M.posto] = M;
        System.out.println("Inserito " + M.toString());
        p++;
        stampaSituazione();
        Furgone F = new Furgone(p, 300, "Ducato", 1995, 2500);
        elencoVeicoli[F.posto] = F;
        System.out.println("Inserito " + F.toString());
        stampaSituazione();
        rimuovi(F.posto);
        rimuovi(M.posto);
        /*System.out.println(String.valueOf(elencoVeicoli.length));
        Moto M1 = new Moto(0, 4, "aprilia", 2000, 600);
        elencoVeicoli[M1.posto] = M1;
        System.out.println("Inserito " + M1.toString());
        stampaSituazione();*/
